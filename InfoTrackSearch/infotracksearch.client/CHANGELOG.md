...
- Create Angular project with ng: `ng new infotracksearch.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`infotracksearch.client.esproj`).
